  ...
  inquirer
    ...
    .then((answers) => {
      ...
      switch (action) {
        ...
        case "Explore":
          console.log(
            "You enter the historical place and found a hidden city."
          );
          break;
        case "Talk to the wizard":
          console.log(
            "The wizard grants you a magical item to ai you on your journey."
          );
          break;
        default:
    ...
    .then((answers) => {
      ...
      switch (action) {
        case "follow the left path.":
          console.log(
            "You encounter a group of bats, but find a valuable gamestone."
          );
          break;
        case "follow the right path.":
          console.log(
            "You stumble upon a sleeping troll, quietly backtrack and find a scret exit."
          );
          break;
